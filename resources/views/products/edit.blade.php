...
<div class="my-5" style="width: 50%">
  <form action="{{ route('ProductUpdate', $product->id) }}" method="post" enctype="multipart/form-data">
    ...
    <div class="mb-3">
      ...
      <textarea name="description_ar"class="form-control" id="description_ar" cols="30" rows="5">
    ...
    <div class="mb-3">
      ...
      <input type="number" min="0" class="form-control" id="start_price" name="start_price" value="{{ $product->start_price }}">
    </div>
    <div class="mb-3">
      <label for="duration" class="form-label">Duration</label>
      <select class="form-select" aria-label="Default select example" name="duration">
        <option selected value="{{ $product->duration }}" >{{ $product->duration }} Days</option>
